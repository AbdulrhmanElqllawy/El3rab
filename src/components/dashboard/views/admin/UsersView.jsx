...
import { Search, UserPlus, Edit2, Trash2, Shield, Ban, RotateCcw, Eye, ChevronDown } from 'lucide-react';
...
export default function UsersView({ subSection = 'users_all' }) {
    ...
    return (
        <div className="p-4 lg:p-6 space-y-5" dir="rtl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                    <h2 className="text-xl font-black text-gray-900 dark:text-[#F1F5F9]">إدارة المستخدمين</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">إدارة جميع مستخدمي المنصة</p>
                </div>
                                ...
                                <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-white/2 transition-colors">
                                    ...
                                    <td className="px-4 py-3.5">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <ActionBtn icon={Edit2}    tip="تعديل"           color="text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-500/10" />
                                            <ActionBtn icon={Shield}   tip="تغيير الدور"    color="text-yellow-600 hover:bg-yellow-50 dark:hover:bg-yellow-500/10" />
                                            ...
                                            <ActionBtn icon={Trash2}   tip="حذف"             color="text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10" />
                                        </div>
                                    </td>
                                </tr>
                            ))}
